...
export const metadata: Metadata = {
  title: 'Sarah Johnson - Lead Developer | Exodos',
  description: 'Learn more about Sarah Johnson, our Lead Developer with 8+ years of experience in Next.js, React, and TypeScript.',
}
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/3 bg-gradient-to-br from-blue-100 to-blue-200 p-8 flex items-center justify-center">
              <div className="text-center">
                <div className="w-48 h-48 bg-gradient-to-br from-blue-200 to-blue-300 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-4xl font-bold text-blue-700">SJ</span>
                </div>
                <div className="space-y-3">
                  <a href="mailto:sarah@exodos.com" className="flex items-center justify-center text-blue-600 hover:text-blue-800 transition-colors">
            ...
            <div className="md:w-2/3 p-8">
              <div className="mb-6">
                ...
                <p className="text-xl text-blue-600 font-medium mb-1">Lead Developer</p>
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">About Sarah</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Sarah is a passionate full-stack developer with over 8 years of experience in modern web technologies. 
                  She specializes in Next.js, React, and TypeScript, and leads our development team in creating scalable, 
                  accessible web applications that deliver exceptional user experiences.
                </p>

                <p className="text-gray-700 leading-relaxed mb-6">
                  Before joining Exodos, Sarah worked at several high-growth startups where she honed her skills in 
                  rapid prototyping, agile development, and building products that scale. She has a particular passion 
                  for performance optimization and ensuring that applications are accessible to all users.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Backend & Cloud</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div className="space-y-3 mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">University of California, Berkeley • 2016</p>
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h4 className="font-medium text-gray-900">E-commerce Platform Modernization</h4>
                    <p className="text-sm text-gray-600 mt-1">
                      Led the migration of a legacy e-commerce platform to Next.js, resulting in 40% faster page loads 
                      and improved SEO rankings.
                    </p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h4 className="font-medium text-gray-900">Accessibility Compliance Initiative</h4>
                    <p className="text-sm text-gray-600 mt-1">
                      Spearheaded company-wide accessibility improvements, achieving WCAG 2.1 AA compliance across 
                      all client projects.
                    </p>
                  </div>
                </div>
